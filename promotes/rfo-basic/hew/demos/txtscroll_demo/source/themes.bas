...
fn.def theme_init ()			% init and load themes
	...
	bundle.put theme,"p_title",	 "255,140,10,10,0"
	bundle.put theme,"p_title_bg",	 "255,230,230,250,1"

	bundle.put theme,"p_text",	  "255,0,0,150,0"
	bundle.put theme,"p_text_highlight","255,200,0,0,0"

	bundle.put theme,"p_btn_border", "255,80,80,150,1"
	bundle.put theme,"p_btn_text",   "255,30,30,30,0"
	bundle.put theme,"p_btn_backgnd","255,250,250,250,1"
	bundle.put theme,"p_btn_press_txt",  "255,0,0,0,0"
	bundle.put theme,"p_btn_press_bg",  "255,200,200,230,1"

	bundle.put theme,"p_np_border", "255,80,80,150,1"
	bundle.put theme,"p_np_text",   "255,30,30,30,0"
	bundle.put theme,"p_np_backgnd","255,250,250,250,1"
	bundle.put theme,"p_np_press_txt",  "255,0,0,0,0"
	...
	bundle.put theme,"p_tsc_text1",   "255,30,30,30,0"
	bundle.put theme,"p_tsc_text2", "255,140,10,10,0"
	bundle.put theme,"p_tsc_text3",  "255,80,80,150,0"

	bundle.put theme,"p_tbx_border", "255,80,80,150,0"
	bundle.put theme,"p_tbx_label", "255,80,80,150,0"
	bundle.put theme,"p_tbx_text",   "255,30,30,30,0"
	bundle.put theme,"p_tbx_backgnd","255,255,255,255,1"

	bundle.put theme,"p_kin_border", "255,80,80,150,1"
	bundle.put theme,"p_kin_label",  "255,220,220,240,0"
	bundle.put theme,"p_kin_text",   "255,30,30,30,0"
	bundle.put theme,"p_kin_backgnd","255,250,250,250,1"

	bundle.put theme,"p_pf_backgnd","255,240,240,240,1"
	bundle.put theme,"p_pf_blink",  "180,200,200,230,1"
	bundle.put theme,"p_pf_line",  "255,0,0,0,0"
	bundle.put theme,"p_pf_label",  "255,0,0,0,0"
	bundle.put theme,"p_pf_title_bg",  "255,80,80,150,1"
	bundle.put theme,"p_pf_title_fg",  "255,240,240,240,0"

	bundle.put theme,"p_pf_txinbg",  "255,250,250,250,1"
	bundle.put theme,"p_pf_txinfg",  "255,0,0,150,0"
	...
	bundle.put theme,"p_pf_nf",  "255,255,255,255,0"
