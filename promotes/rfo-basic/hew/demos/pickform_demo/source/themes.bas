...
% v5.6
%---------------------------------------
fn.def theme_color (name$)	 	% set current color with color name$
...
fn.end
%---------------------------------------
fn.def theme_recolor (name$,p)	 	% recolor existing paint with color name$ of current theme
					% or a user-defined color starting with "u,"+"AAA,RRR,GGG,BBB,Style"
	if starts_with ("u,",name$) then
		color$=right$(name$, -2)
	else
		bundle.get 1, "theme", colors	% get the current theme
		bundle.get colors, name$, color$
...
fn.def theme_init ()			% init and load themes
	...
	bundle.put theme,"p_title_bg", "255,230,230,250,1"
				...
				% widgets that don't have their own colors use 'gen'
	bundle.put theme,"p_gen_border", "255,80,80,150,1"
	bundle.put theme,"p_gen_backg","255,250,250,250,1"
	bundle.put theme,"p_gen_text", "255,30,30,30,1"
	bundle.put theme,"p_gen_dimmed", "255,100,100,100,1"
	bundle.put theme,"p_gen_label", "255,80,80,150,1"
	...
	bundle.put theme,"p_btn_backg","255,240,240,255,1"
	...
	bundle.put theme,"p_np_backg", "255,250,250,250,1"
	...
	bundle.put theme,"p_msg_backg","255,240,240,255,1"
	bundle.put theme,"p_msg_text", "255,30,30,30,1"

	bundle.put theme,"p_btm_backg", "255,220,220,220,1"
	...
	bundle.put theme,"p_tsc_backg","255,250,250,250,1"
	...
	bundle.put theme,"p_kin_backg","255,250,250,250,1"

	bundle.put theme,"p_pf_backg", "255,240,240,240,1"
	...
	bundle.put theme,"p_pl_backg","255,240,240,240,1"
	...
	bundle.put theme,"p_ch_backg","255,255,255,255,1"
